...
class Container_6f2817c4f5 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_6f2817c4f5 $container)
			{
	...
	public function createServiceContainer(): Container_6f2817c4f5
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'APP_KEY' => 'base64:oN5T8vRyMzY8FfBDs9gMguWUBGWxUc9DDH79KZ+TP7Y=',
				'APP_LOCALE' => 'en',
				...
				'DB_DATABASE' => 'C:/Users/31687/Desktop/chat-backend-node/prisma/dev.db',
				...
				'JWT_AUDIENCE' => 'chatapp',
				'JWT_ISSUER' => 'laravel',
				'JWT_SECRET' => 'zA0iFWtcXTraybf1cGdqC2VKhyruTqe6B1YPZw0rvOKrhhcVRxL4RzFN02e0fk82',
				'JWT_SECRET_SHARED' => 'uEZJtn3w2nivI93Bs8c1EEmbaq3NaV86agSwWsZxSYTRc1sKxg6/2jJmrDXeW/SBkaMqHP77YyURgmFpEQjlqw==',
				'LINES' => '12',
				...
				'NODE_JWT_SECRET' => 'super_long_random_string',
